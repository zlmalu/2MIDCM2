    ...
    t.fn.getCombo = function() {
        ...
        t.Combo.prototype = {
            ...
            _blur: function() {
                if (this.active) {
                    ...
                    if (this.opts.editable && this.opts.forceSelection) {
                        this.selectByText(this.input.val()); - 1 == this._selectedIndex && this.input.val("")
                    }
            ...
            _bindEvent: function() {
                ...
                e.editable ? i.input.on("click",
                    function() {}) : i.input.on("click",
                    function() {
                        i._onTriggerClick()
                    });
                i.trigger && i.trigger.on("click",
                    function() {
                        i._onTriggerClick()
                    });
                t(document).on("click",
            ...
            _bindKeyEvent: function() {
                ...
                this.input.on("keydown",
                    ...
                    function(t) {
                        if (e.editable) {
                            var a = t.which,
                                o = 8 == a || 9 == a || 13 == a || 27 == a || a >= 16 && 20 >= a || a >= 33 && 40 >= a || a >= 44 && 46 >= a || a >= 112 && 123 >= a || 144 == a || 145 == a,
                                l = i.input.val();
            ...
            _createCombo: function() {
                var i, e, s, a = this.opts,
                    o = parseInt(this.opts.width);
                this.originSelect && this.originSelect.hide();
                if ("input" == this.obj[0].tagName.toLowerCase()) this.input = this.obj;
                else {
                ...
                this.input.attr({
                    ...
                    cursor: a.editable ? "": "default"
                });
                s = this.obj.find("." + a.triggerCls);
                ...
                if (i.length > 0) this.wrap = i;
                //if (i.length > 0) this.wrap = i.append(this.input, this.trigger);
                ...
                this.list = t("<div />").addClass(a.listCls).css({
                    position: "relative",
                    overflow: "auto"
                });
            ...
            _setListLayout: function() {
                var t, i, e = this.opts,
                    s = parseInt(e.listHeight),
                    a = 0,
                    o = this.trigger ? this.trigger.outerWidth() : 0,
                    l = parseInt(e.minListWidth),
                    n = parseInt(e.maxListWidth);
                ...
                l = isNaN(l) ? this.wrap.outerWidth() : Math.max(l, this.wrap.outerWidth()); ! isNaN(l) && l > t && (t = l); ! isNaN(n) && t > n && (t = n);
            ...
            _setComboLayout: function(t) {
                if (t) {
                    var i = this.opts,
                        e = parseInt(i.maxWidth),
                        s = parseInt(i.minWidth); ! isNaN(e) && t > e && (t = e); ! isNaN(s) && s > t && (t = s);
                    var a;
            ...
            _setListPosition: function() {
                if (this.isExpanded) {
                    var i, e, s = (this.opts, t(window)),
                        ...
                        r = s.scrollTop(),
                        h = s.scrollLeft(),
                        d = this.wrap.outerHeight(),
                        c = this.wrap.outerWidth(),
                        u = this.listWrap.outerHeight(),
            ...
            _loadAjaxData: function(i, e, s) {
                var a = this,
                    o = a.opts,
                    l = o.ajaxOptions,
                    n = t("<div />").addClass(o.loadingCls).text(l.loadingText);
                a.list.append(n);
            ...
            _setDefaultSelected: function(i, e) {
                ...
                if (isNaN(parseInt(i))) if (t.isArray(i)) this.selectByKey(i[0], i[1], e);
                else if (this.originSelect) {
                    var a = this.originSelect[0].selectedIndex;
                    this._setSelected(a, e)
                } else s.autoSelect && this._setSelected(0, e);
                else {
                    var a = parseInt(i);
                    this._setSelected(a, e)
                }
            ...
            selectByText: function(t, i) {
                if (this.formattedData) {
                    for (var e = this.formattedData,
                             s = -1,
                             a = 0,
                             o = e.length; o > a; a++) if (e[a].text === t) {
                        s = a;
                        break
                    }
            ...
            selectByValue: function(t, i) {
                if (this.formattedData) {
                    for (var e = this.formattedData,
                             s = -1,
                             a = 0,
                             o = e.length; o > a; a++) if (e[a].value === t) {
                        s = a;
                        break
                    }
                    this._setSelected(s, i)
            ...
            selectByKey: function(t, i, e) {
                if (this.rawData) {
                    ...
                    if (a.addOptions) {
                        ...
                        for (var n = 0,
                                 r = o.length; r > n; n++) if (o[n].value === i) {
                            l = n;
                            break
                        }
                    } else for (var n = 0,
                                    r = o.length; r > n; n++) if (o[n][t] === i) {
                        l = n;
                        break
                    }
            ...
            _setSelected: function(t, i) {
                ...
                if (!isNaN(t)) if (this.formattedData && 0 != this.formattedData.length) {
                    var s = this.formattedData.length; ( - 1 > t || t >= s) && (t = -1);
                    if (this._selectedIndex != t) {
                        {
                            var a = -1 == t ? null: this.formattedData[t],
                                o = -1 == t ? null: a.rawData,
                                l = -1 == t ? "": a.text;
            ...
            _formatData: function() {
                if (t.isArray(this.rawData)) {
                    var i = this,
                        e = i.opts;
                    i.formattedData = [];
                    e.emptyOptions && i.formattedData.push({
                        text: "(空)",
                        value: 0
                    });
                    ...
                    i.formattedLen = i.formattedData.length
                }
            },
            _filter: function(i) {
                function e() {
                ...
                if (t.isArray(this.formattedData)) {
                    if ("" == i) this.filterData = this.formattedData;
                    else {
                        this.filterData = [];
                        var o = [];
                        t.each(a.formattedData,
                            function(e, l) {
                                var n = l.text;
                                if (t.isFunction(s.customMatch)) {
                                    if (!s.customMatch(n, i)) return
                                } else {
                                    var r = s.caseSensitive ? "": "i",
                                        h = new RegExp(i.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), r);
                                    if ( - 1 == n.search(h)) return
                                }
                                a.filterData.push(l);
                                o.push({
                                    i: e,
                                ...
                                return a.filterData.length == s.maxFilter ? !1 : void 0
                            })
                    }
                    if (100 === a.formattedLen && a.filterData.length < s.maxFilter) a.addQuery === !0 && this.incrementalSearch(o, e);
                    else {
                        this.lastQuery = i;
                        this.list.empty();
                        this._populateList(this.filterData);
            ...
            _scrollToItem: function(t) {
                if (t && 0 != t.length) {
                    var i = this.list.scrollTop(),
                        e = i + t.position().top,
                        f = t.position().top,
                        s = i + this.list.height(),
                        a = e + t.outerHeight(); 
(e==0 || a > s) && this.list.scrollTop(e)
                }
            },
            _scrollPage: function(t) {
                var i, e = this.list.scrollTop(),
                    s = this.list.height();
            ...
            _setItemFocus: function(t) {
                var i, e, s = this.opts,
                    a = this.list.find("." + s.listItemCls);
                if (0 != a.length) {
    ...
    function(t) {
        t.extend(t.fn, {
            validate: function(e) {
                ...
                return i ? i: ("undefined" != typeof Worker && this.attr("novalidate", "novalidate"), i = new t.validator(e, this[0]), t.data(this[0], "validator", i), i.settings.onsubmit && (this.validateDelegate(":submit", "click",
                    function(e) {
            ...
            rules: function(e, i) {
                var s = this[0];
                if (e) {
                    var a = t.data(s.form, "validator").settings,
                        n = a.rules,
                    ...
                    switch (e) {
                        case "add":
                            t.extend(r, t.validator.normalizeRule(i)),
                                delete r.messages,
                                n[s.name] = r,
                            i.messages && (a.messages[s.name] = t.extend(a.messages[s.name], i.messages));
                            break;
                        case "remove":
            ...
            t.extend(t.validator, {
                ...
                prototype: {
                    ...
                    formatAndAdd: function(e, i) {
                        var s = this.defaultMessage(e, i.method),
                            a = /\$?\{(\d+)\}/g;
                        "function" == typeof s ? s = s.call(this, i.parameters, e) : a.test(s) && (s = t.validator.format(s.replace(a, "{$1}"), i.parameters)),
                            this.errorList.push({
                                message: s,
                                element: e
                            }),
                ...
                attributeRules: function(e) {
                    ...
                    for (var n in t.validator.methods) {
                        var r;
                        "required" === n ? (r = s.get(0).getAttribute(n), "" === r && (r = !0), r = !!r) : r = s.attr(n),
                        /min|max/.test(n) && (null === a || /number|range|text/.test(a)) && (r = Number(r)),
                            r ? i[n] = r: a === n && "range" !== a && (i[n] = !0)
                    }
                ...
                methods: {
                    ...
                    equalTo: function(e, i, s) {
                        var a = t(s);
                        return this.settings.onfocusout && a.unbind(".validate-equalTo").bind("blur.validate-equalTo",
                            function() {
                                t(i).valid()
                            }),
                        e === a.val()
    ...
    function(t) {
        ...
        if (t.ajaxPrefilter) t.ajaxPrefilter(function(t, i, s) {
            ...
            var i = t.ajax;
            t.ajax = function(s) {
                var a = ("mode" in s ? s: t.ajaxSettings).mode,
    ...
    function(t) {
                    ...
                    case "click":
                        t(this).click(function(i) {
                            if (e.display && e.trigger && i.target === e.trigger.get(0)) {
                                ...
                                n(r, t(this));
                                e.targetGet();
                                t(document).data("mouseupBind") || t(document).bind("mouseup",
                                    function(i) {
                                        var s = !1;
                                        if (e.trigger) {
        ...
        var e = {
            targetGet: function() {
                ...
                var i = this.trigger.attr(this.s.targetAttr),
                    s = "function" == typeof this.s.target ? this.s.target.call(this.trigger) : this.s.target;
                switch (this.s.targetMode) {
                    ...
                    case "list":
                        ...
                        t.isArray(s) && (o = s.length) ? t.each(s,
                            function(t, e) {
                                var i, s, a = "",
                                    r = "";
            ...
            position: function() {
                ...
                var i, s, a, r, n, o, l, h = 0,
                    u = 0,
                    d = 0,
                    c = 0,
                    f = this.target.data("height"),
                    g = this.target.data("width"),
                    p = t(window).scrollTop(),
                    m = parseInt(this.s.offsets.x, 10) || 0,
                    v = parseInt(this.s.offsets.y, 10) || 0,
                    F = this.cacheData;
                if (!f) {
                ...
                var y, w = ["4-1", "1-4", "5-7", "2-3", "2-1", "6-8", "3-4", "4-3", "8-6", "1-2", "7-5", "3-2"],
                    C = this.s.position,
                    D = !1;
                t.each(w,
                    function(t, e) {
                ...
                c && d && this.corner && this.corner.css({
                    left: o,
                    top: l,
    ...
    function(t, e) {
        ...
        var i = "function" == typeof moment,
            ...
            y = function(t, i, s) {
                ...
                for (a in i) {
                    n = t[a] !== e;
                    n && "object" == typeof i[a] && i[a].nodeName === e ? g(i[a]) ? s && (t[a] = new Date(i[a].getTime())) : f(i[a]) ? s && (t[a] = i[a].slice(0)) : t[a] = y({},
                        i[a], s) : (s || !n) && (t[a] = i[a])
                }
                return t
            },
            ...
            S = function(t) {
                var e, i, s, a, n, r = t._o,
                    o = t._m,
                    l = t._y,
                    h = l === r.minYear,
                    u = l === r.maxYear,
                    d = '<div class="pika-title">',
                    c = !0,
                    g = !0;
        ...
        L.prototype = {
            ...
            toString: function(t) {
                if (!g(this._d)) return "";
                var e = this._d.getFullYear(),
                    s = this._d.getMonth() + 1,
                    a = this._d.getDate();
                s = 10 > s ? "0" + s: s;
                a = 10 > a ? "0" + a: a;
            ...
            draw: function(t) {
                if (this._v || t) {
                    var e = this._o,
                        ...
                        r = e.maxMonth;
                    if (this._y <= i) {
                        this._y = i; ! isNaN(a) && this._m < a && (this._m = a)
                    }
                    if (this._y >= s) {
            ...
            adjustPosition: function() {
                var e, i, s, n = this._o.trigger,
                    r = n,
                    o = this.el.offsetWidth,
                    l = this.el.offsetHeight,
                    h = t.innerWidth || a.documentElement.clientWidth,
                    u = t.innerHeight || a.documentElement.clientHeight,
                    f = t.pageYOffset || a.body.scrollTop || a.documentElement.scrollTop;
                d(this.el, "is-hidden");
            ...
            render: function(t, e) {
                ...
                for (var u = 0,
                         d = 0; l > u; u++) {
                    var c = new Date(t, e, 1 + (u - n)),
                        f = i.minDate && c < i.minDate || i.maxDate && c > i.maxDate,
                        p = g(this._d) ? b(c, this._d) : !1,
                        m = b(c, s),
                        y = n > u || u >= a + n;
    ...
    function(t, e) {
        t.define && "function" == typeof define ? define("/js/common/plugins/datepicker/pikaday", ["jquery"],
            function(i) {
        ...
        function(t, e) {
            t && (t.fn.datepicker = t.fn.pikaday = function() {
                ...
                return this.each(function() {
                    var s = t(this),
                        a = s.data("pikaday");
                    if (a instanceof e)"string" == typeof i[0] && "function" == typeof a[i[0]] && a[i[0]].apply(a, Array.prototype.slice.call(i, 1));
    ...
    function($) {
        var settings = {},
            ...
            _bindEvent = function(e) {
                var t = e.treeObj,
                    i = consts.event;
                t.bind(i.NODECREATED,
                    function(t, i, a) {
                        tools.apply(e.callback.onNodeCreated, [t, i, a])
                    });
                t.bind(i.CLICK,
                    function(t, i, a, n, s) {
                        tools.apply(e.callback.onClick, [i, a, n, s])
                    });
                t.bind(i.EXPAND,
                    function(t, i, a) {
                        tools.apply(e.callback.onExpand, [t, i, a])
                    });
                t.bind(i.COLLAPSE,
                    function(t, i, a) {
                        tools.apply(e.callback.onCollapse, [t, i, a])
                    });
                t.bind(i.ASYNC_SUCCESS,
                    function(t, i, a, n) {
                        tools.apply(e.callback.onAsyncSuccess, [t, i, a, n])
                    });
                t.bind(i.ASYNC_ERROR,
                    function(t, i, a, n, s, o) {
                        tools.apply(e.callback.onAsyncError, [t, i, a, n, s, o])
                    });
                t.bind(i.REMOVE,
                    function(t, i, a) {
                        tools.apply(e.callback.onRemove, [t, i, a])
                    })
            },
            ...
            _eventProxy = function(e) {
                var t = e.target,
                    ...
                    l = null,
                    d = null;
                if (tools.eqs(e.type, "mousedown")) o = "mousedown";
                else if (tools.eqs(e.type, "mouseup")) o = "mouseup";
                else if (tools.eqs(e.type, "contextmenu")) o = "contextmenu";
                else if (tools.eqs(e.type, "click")) if (tools.eqs(t.tagName, "span") && null !== t.getAttribute("treeNode" + consts.id.SWITCH)) {
                    a = tools.getNodeMainDom(t).id;
                    s = "switchNode"
                } else {
                    d = tools.getMDom(i, t, [{
                        tagName: "a",
                ...
                if (o.length > 0 && 0 == a.length) {
                    ...
                    d && (a = tools.getNodeMainDom(d).id)
                }
                if (a.length > 0) {
                    n = data.getNodeCache(i, a);
                    switch (s) {
                        case "switchNode":
                            n.isParent ? tools.eqs(e.type, "click") || tools.eqs(e.type, "dblclick") && tools.apply(i.view.dblClickExpand, [i.treeId, n], i.view.dblClickExpand) ? r = handler.onSwitchNode: s = "": s = "";
                            break;
                        case "clickNode":
            ...
            _initNode = function(e, t, i, a, n, s) {
                if (i) {
            ...
            data = {
                ...
                addNodesData: function(e, t, i) {
                    ...
                    t[a] || (t[a] = []);
                    if (t[a].length > 0) {
                        t[a][t[a].length - 1].isLastNode = !1;
                        view.setNodeLineIcos(e, t[a][t[a].length - 1])
                    }
                    t.isParent = !0;
                    t[a] = t[a].concat(i)
                },
                ...
                getAfterA: function() {
                    for (var e = 0,
                             t = _init.afterA.length; t > e; e++) _init.afterA[e].apply(this, arguments)
                },
                getBeforeA: function() {
                    for (var e = 0,
                             t = _init.beforeA.length; t > e; e++) _init.beforeA[e].apply(this, arguments)
                },
                getInnerAfterA: function() {
                    for (var e = 0,
                             t = _init.innerAfterA.length; t > e; e++) _init.innerAfterA[e].apply(this, arguments)
                },
                getInnerBeforeA: function() {
                    for (var e = 0,
                             t = _init.innerBeforeA.length; t > e; e++) _init.innerBeforeA[e].apply(this, arguments)
                },
                getCache: function(e) {
                ...
                getNextNode: function(e, t) {
                    ...
                    for (var i = e.data.key.children,
                             a = t.parentTId ? t.getParentNode() : data.getRoot(e), n = 0, s = a[i].length - 1; s >= n; n++) if (a[i][n] === t) return n == s ? null: a[i][n + 1];
                    return null
                },
                getNodeByParam: function(e, t, i, a) {
                    if (!t || !i) return null;
                    for (var n = e.data.key.children,
                             s = 0,
                             o = t.length; o > s; s++) {
                        if (t[s][i] == a) return t[s];
                        var r = data.getNodeByParam(e, t[s][n], i, a);
                        if (r) return r
                    }
                    return null
                },
                ...
                getNodesByParam: function(e, t, i, a) {
                    if (!t || !i) return [];
                    for (var n = e.data.key.children,
                             s = [], o = 0, r = t.length; r > o; o++) {
                        t[o][i] == a && s.push(t[o]);
                        s = s.concat(data.getNodesByParam(e, t[o][n], i, a))
                    }
                    return s
                },
                getNodesByParamFuzzy: function(e, t, i, a) {
                    if (!t || !i) return [];
                    ...
                    for (var o = 0,
                             r = t.length; r > o; o++) {
                        "string" == typeof t[o][i] && t[o][i].toLowerCase().indexOf(a) > -1 && s.push(t[o]);
                        s = s.concat(data.getNodesByParamFuzzy(e, t[o][n], i, a))
                    }
                    return s
                },
                getNodesByFilter: function(e, t, i, a, n) {
                    if (!t) return a ? null: [];
                    for (var s = e.data.key.children,
                             o = a ? null: [], r = 0, l = t.length; l > r; r++) {
                        if (tools.apply(i, [t[r], n], !1)) {
                            if (a) return t[r];
                            o.push(t[r])
                        }
                        var d = data.getNodesByFilter(e, t[r][s], i, a, n);
                        if (a && d) return d;
                        o = a ? d: o.concat(d)
                    }
                    return o
                ...
                getPreNode: function(e, t) {
                    if (!t) return null;
                    for (var i = e.data.key.children,
                             a = t.parentTId ? t.getParentNode() : data.getRoot(e), n = 0, s = a[i].length; s > n; n++) if (a[i][n] === t) return 0 == n ? null: a[i][n - 1];
                    return null
                },
                getRoot: function(e) {
                ...
                initCache: function() {
                    for (var e = 0,
                             t = _init.caches.length; t > e; e++) _init.caches[e].apply(this, arguments)
                },
                initNode: function() {
                    for (var e = 0,
                             t = _init.nodes.length; t > e; e++) _init.nodes[e].apply(this, arguments)
                },
                initRoot: function() {
                    for (var e = 0,
                             t = _init.roots.length; t > e; e++) _init.roots[e].apply(this, arguments)
                },
                isSelectedNode: function(e, t) {
                    for (var i = data.getRoot(e), a = 0, n = i.curSelectedList.length; n > a; a++) if (t === i.curSelectedList[a]) return ! 0;
                    return ! 1
                },
                removeNodeCache: function(e, t) {
                    var i = e.data.key.children;
                    if (t[i]) for (var a = 0,
                                       n = t[i].length; n > a; a++) arguments.callee(e, t[i][a]);
                    data.getCache(e).nodes[data.getNodeCacheId(t.tId)] = null
                },
                removeSelectedNode: function(e, t) {
                    for (var i = data.getRoot(e), a = 0, n = i.curSelectedList.length; n > a; a++) if (t === i.curSelectedList[a] || !data.getNodeCache(e, i.curSelectedList[a].tId)) {
                        i.curSelectedList.splice(a, 1);
                        a--;
                        n--
                    }
                },
                ...
                setZTreeTools: function() {
                    for (var e = 0,
                             t = _init.zTreeTools.length; t > e; e++) _init.zTreeTools[e].apply(this, arguments)
                },
                transformToArrayFormat: function(e, t) {
                    if (!t) return [];
                    var i = e.data.key.children,
                        a = [];
                    if (tools.isArray(t)) for (var n = 0,
                                                   s = t.length; s > n; n++) {
                        a.push(t[n]);
                        t[n][i] && (a = a.concat(data.transformToArrayFormat(e, t[n][i])))
                    } else {
                        a.push(t);
                        t[i] && (a = a.concat(data.transformToArrayFormat(e, t[i])))
                    }
                    return a
                },
                transformTozTreeFormat: function(e, t) {
                    var i, a, n = e.data.simpleData.idKey,
                    ...
                    if (tools.isArray(t)) {
                        var r = [],
                            l = [];
                        for (i = 0, a = t.length; a > i; i++) l[t[i][n]] = t[i];
                        for (i = 0, a = t.length; a > i; i++) if (l[t[i][s]] && t[i][n] != t[i][s]) {
                            l[t[i][s]][o] || (l[t[i][s]][o] = []);
                            l[t[i][s]][o].push(t[i])
                        } else r.push(t[i]);
                        return r
            ...
            event = {
                bindEvent: function() {
                    for (var e = 0,
                             t = _init.bind.length; t > e; e++) _init.bind[e].apply(this, arguments)
                },
                unbindEvent: function() {
                    for (var e = 0,
                             t = _init.unbind.length; t > e; e++) _init.unbind[e].apply(this, arguments)
                },
                bindTree: function(e) {
                    var t = {
                            treeId: e.treeId
                        ...
                        i = e.treeObj;
                    e.view.txtSelectedEnable || i.bind("selectstart",
                        function(e) {
                ...
                doProxy: function() {
                    for (var e = [], t = 0, i = _init.proxys.length; i > t; t++) {
                        var a = _init.proxys[t].apply(this, arguments);
                        e.push(a);
                        if (a.stop) break
                    }
                    return e
                ...
                proxy: function(e) {
                    ...
                    for (var i = event.doProxy(e), a = !0, n = !1, s = 0, o = i.length; o > s; s++) {
                        var r = i[s];
                        if (r.nodeEventCallback) {
                            n = !0;
                            a = r.nodeEventCallback.apply(r, [e, r.node]) && a
                        }
                        if (r.treeEventCallback) {
                            n = !0;
                            a = r.treeEventCallback.apply(r, [e, r.node]) && a
                        }
                    }
                    return a
                }
            ...
            handler = {
                ...
                onClickNode: function(e, t) {
                    var i = data.getSetting(e.data.treeId),
                        a = i.view.autoCancelSelected && (e.ctrlKey || e.metaKey) && data.isSelectedNode(i, t) ? 0 : i.view.autoCancelSelected && (e.ctrlKey || e.metaKey) && i.view.selectedMulti ? 2 : 1;
                    if (0 == tools.apply(i.callback.beforeClick, [i.treeId, t, a], !0)) return ! 0;
                    0 === a ? view.cancelPreSelectedNode(i, t) : view.selectNode(i, t, 2 === a);
                    i.treeObj.trigger(consts.event.CLICK, [e, i.treeId, t, a]);
                    return ! 0
                },
            ...
            tools = {
                ...
                getMDom: function(e, t, i) {
                    ...
                    for (; t && t.id !== e.treeId;) {
                        for (var a = 0,
                                 n = i.length; t.tagName && n > a; a++) if (tools.eqs(t.tagName, i[a].tagName) && null !== t.getAttribute(i[a].attrName)) return t;
                        t = t.parentNode
                    }
                    return null
                },
            ...
            view = {
                    ...
                    if (!e.data.keep.leaf || !t || t.isParent) {
                        ...
                        if (t) {
                            var n = $$(t, consts.id.SWITCH, e),
                                ...
                                o = $$(t, consts.id.UL, e);
                            if (!t.open) {
                                view.replaceSwitchClass(t, n, consts.folder.CLOSE);
                ...
                appendNodes: function(e, t, i, a, n, s) {
                    if (!i) return [];
                    for (var o = [], r = e.data.key.children, l = 0, d = i.length; d > l; l++) {
                        ...
                        if (n) {
                            var u = a ? a: data.getRoot(e),
                                h = u[r],
                                f = h.length == i.length && 0 == l,
                                g = l == i.length - 1;
                            data.initNode(e, t, c, a, f, g, s);
                            data.addNodeCache(e, c)
                        }
                        var p = [];
                        c[r] && c[r].length > 0 && (p = view.appendNodes(e, t + 1, c[r], c, n, s && c.open));
                        if (s) {
                ...
                cancelPreSelectedNode: function(e, t) {
                    for (var i = data.getRoot(e).curSelectedList, a = 0, n = i.length - 1; n >= a; n--) if (!t || t === i[n]) {
                        $$(i[n], consts.id.A, e).removeClass(consts.node.CURSELECTED);
                        if (t) {
                ...
                createNodes: function(e, t, i, a) {
                    if (i && 0 != i.length) {
                        var n = data.getRoot(e),
                            s = e.data.key.children,
                            o = !a || a.open || !!$$(a[s][0], e).get(0);
                        n.createdNodes = [];
                        var r = view.appendNodes(e, t, i, a, !0, o);
                        if (a) {
                            var l = $$(a, consts.id.UL, e);
                ...
                expandCollapseNode: function(e, t, i, a, n) {
                        ...
                        if (t.open != i) {
                            ...
                            if (t.isParent) {
                                ...
                                if (t.open) {
                                    ...
                                    if (0 == a || "" == e.view.expandSpeed) {
                                        l.show();
                                        tools.apply(n, [])
                                    } else if (t[o] && t[o].length > 0) l.slideDown(e.view.expandSpeed, n);
                                    else {
                                        l.show();
                                        tools.apply(n, [])
                                    }
                                    ...
                                    if (0 != a && "" != e.view.expandSpeed && (t[o] && t[o].length > 0)) l.slideUp(e.view.expandSpeed, n);
                                    else {
                                        l.hide();
                                        tools.apply(n, [])
                                    }
                ...
                expandCollapseParentNode: function(e, t, i, a, n) {
                    if (t) if (t.parentTId) {
                        view.expandCollapseNode(e, t, i, a);
                        t.parentTId && view.expandCollapseParentNode(e, t.getParentNode(), i, a, n)
                    } else view.expandCollapseNode(e, t, i, a, n)
                },
                expandCollapseSonNode: function(e, t, i, a, n) {
                    var s = data.getRoot(e),
                        o = e.data.key.children,
                        r = t ? t[o] : s[o],
                        l = t ? !1 : a,
                    ...
                    if (r) for (var c = 0,
                                    u = r.length; u > c; c++) r[c] && view.expandCollapseSonNode(e, r[c], i, l);
                    data.getRoot(e).expandTriggerFlag = d;
                    view.expandCollapseNode(e, t, i, a, n)
                },
                makeDOMNodeIcon: function(e, t, i) {
                    var a = data.getNodeName(t, i),
                        n = t.view.nameIsHTML ? a: a.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
                ...
                makeDOMNodeNameBefore: function(e, t, i) {
                    var a = data.getNodeTitle(t, i),
                        n = view.makeNodeUrl(t, i),
                        s = view.makeNodeFontCss(t, i),
                        o = [];
                    for (var r in s) o.push(r, ":", s[r], ";");
                    e.push("<a id='", i.tId, consts.id.A, "' class='", consts.className.LEVEL, i.level, "' treeNode", consts.id.A, ' onclick="', i.click || "", '" ', null != n && n.length > 0 ? "href='" + n + "'": "", " target='", view.makeNodeTarget(i), "' style='", o.join(""), "'");
                    tools.apply(t.view.showTitle, [t.treeId, i], t.view.showTitle) && a && e.push("title='", a.replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "'");
                    e.push(">")
                },
                ...
                makeNodeIcoStyle: function(e, t) {
                    ...
                    if (!t.isAjaxing) {
                        ...
                        a && i.push("background:url(", a, ") 0 0 no-repeat;");
                ...
                removeChildNodes: function(e, t) {
                    if (t) {
                        ...
                        if (a) {
                            for (var n = 0,
                                     s = a.length; s > n; n++) data.removeNodeCache(e, a[n]);
                            data.removeSelectedNode(e);
                            delete t[i];
                            if (e.data.keep.parent) $$(t, consts.id.UL, e).empty();
                            else {
                                t.isParent = !1;
                                t.open = !1;
                ...
                setFirstNode: function(e, t) {
                    var i = e.data.key.children,
                        a = t[i].length;
                    a > 0 && (t[i][0].isFirstNode = !0)
                },
                setLastNode: function(e, t) {
                    var i = e.data.key.children,
                        a = t[i].length;
                    a > 0 && (t[i][a - 1].isLastNode = !0)
                },
                removeNode: function(e, t) {
                    ...
                    if (data.getNodeCache(e, t.tId)) {
                        ...
                        data.removeSelectedNode(e, t);
                        for (var s = 0,
                                 o = n[a].length; o > s; s++) if (n[a][s].tId == t.tId) {
                            n[a].splice(s, 1);
                            break
                        }
                        view.setFirstNode(e, n);
                        view.setLastNode(e, n);
                        var r, l, d, c = n[a].length;
                        if (e.data.keep.parent || 0 != c) {
                            if (e.view.showLine && c > 0) {
                                ...
                                if (n == i) if (1 == n[a].length) view.replaceSwitchClass(u, l, consts.line.ROOT);
                                else {
                                    var h = $$(n[a][0], consts.id.SWITCH, e);
                                    view.replaceSwitchClass(n[a][0], h, consts.line.ROOTS);
                            ...
                            n.open = !1;
                            r = $$(n, consts.id.UL, e);
                            l = $$(n, consts.id.SWITCH, e);
                            d = $$(n, consts.id.ICON, e);
                            view.replaceSwitchClass(n, l, consts.folder.DOCU);
                ...
                setNodeLineIcos: function(e, t) {
                    if (t) {
                        ...
                        0 == s.length ? a.removeClass(consts.line.LINE) : a.addClass(s);
                        i.attr("class", view.makeNodeLineClass(e, t));
                        t.isParent ? i.removeAttr("disabled") : i.attr("disabled", "disabled");
                        n.removeAttr("style");
                        n.attr("style", view.makeNodeIcoStyle(e, t));
                        n.attr("class", view.makeNodeIcoClass(e, t))
                    }
                },
                setNodeName: function(e, t) {
                    ...
                    a.empty();
                    e.view.nameIsHTML ? a.html(data.getNodeName(e, t)) : a.text(data.getNodeName(e, t));
        ...
        $.fn.zTree = {
            ...
            init: function(e, t, i) {
                ...
                a.treeObj.empty();
                settings[a.treeId] = a;
                "undefined" == typeof document.body.style.maxHeight && (a.view.expandSpeed = "");
                data.initRoot(a);
                var n = data.getRoot(a),
                    s = a.data.key.children;
                i = i ? tools.clone(tools.isArray(i) ? i: [i]) : [];
                n[s] = a.data.simpleData.enable ? data.transformTozTreeFormat(a, i) : i;
                data.initCache(a);
                event.unbindTree(a);
                event.bindTree(a);
                event.unbindEvent(a);
                ...
                var o = {
                    ...
                    addNodes: function(e, t, i) {
                        function n() {
                            view.addNodes(a, e, s, 1 == i)
                        }
                        if (!t) return null;
                        e || (e = null);
                        if (e && !e.isParent && a.data.keep.leaf) return null;
                        var s = tools.clone(tools.isArray(t) ? t: [t]);
                        tools.canAsync(a, e) ? view.asyncNode(a, e, i, n) : n();
                        return s
                    },
                    ...
                    expandAll: function(e) {
                        e = !!e;
                        view.expandCollapseSonNode(a, null, e, !0);
                        return e
                    },
                    expandNode: function(e, t, i, n, s) {
                        if (!e || !e.isParent) return null;
                        t !== !0 && t !== !1 && (t = !e.open);
                        s = !!s;
                        if (s && t && 0 == tools.apply(a.callback.beforeExpand, [a.treeId, e], !0)) return null;
                        if (s && !t && 0 == tools.apply(a.callback.beforeCollapse, [a.treeId, e], !0)) return null;
                        t && e.parentTId && view.expandCollapseParentNode(a, e.getParentNode(), t, !1);
                        if (t === e.open && !i) return null;
                        data.getRoot(a).expandTriggerFlag = s;
                        if (!tools.canAsync(a, e) && i) view.expandCollapseSonNode(a, e, t, !0,
                            function() {
                                if (n !== !1) try {
                                    $$(e, a).focus().blur()
                                } catch(t) {}
                    ...
                    getNodeByParam: function(e, t, i) {
                        return e ? data.getNodeByParam(a, i ? i[a.data.key.children] : data.getNodes(a), e, t) : null
                    },
                    getNodeByTId: function(e) {
                        return data.getNodeCache(a, e)
                    },
                    getNodesByParam: function(e, t, i) {
                        return e ? data.getNodesByParam(a, i ? i[a.data.key.children] : data.getNodes(a), e, t) : null
                    },
                    getNodesByParamFuzzy: function(e, t, i) {
                        return e ? data.getNodesByParamFuzzy(a, i ? i[a.data.key.children] : data.getNodes(a), e, t) : null
                    },
                    getNodesByFilter: function(e, t, i, n) {
                        t = !!t;
                        return e && "function" == typeof e ? data.getNodesByFilter(a, i ? i[a.data.key.children] : data.getNodes(a), e, t, n) : t ? null: []
                    },
                    getNodeIndex: function(e) {
                        if (!e) return null;
                        for (var t = a.data.key.children,
                                 i = e.parentTId ? e.getParentNode() : data.getRoot(a), n = 0, s = i[t].length; s > n; n++) if (i[t][n] == e) return n;
                        return - 1
                    },
                    getSelectedNodes: function() {
                        for (var e = [], t = data.getRoot(a).curSelectedList, i = 0, n = t.length; n > i; i++) e.push(t[i]);
                        return e
                    },
                    ...
                    reAsyncChildNodes: function(e, t, i) {
                        if (this.setting.async.enable) {
                            ...
                            n && (e = data.getRoot(a));
                            if ("refresh" == t) {
                                for (var s = this.setting.data.key.children,
                                         o = 0,
                                         r = e[s] ? e[s].length: 0; r > o; o++) data.removeNodeCache(a, e[s][o]);
                                data.removeSelectedNode(a);
                                e[s] = [];
                                if (n) this.setting.treeObj.empty();
                                else {
                                    var l = $$(e, consts.id.UL, a);
                                    l.empty()
                                }
                            }
                    ...
                    refresh: function() {
                        ...
                        data.initRoot(a);
                        e[a.data.key.children] = t;
                        data.initCache(a);
                        view.createNodes(a, 0, e[a.data.key.children])
                    },
                    removeChildNodes: function(e) {
                        if (!e) return null;
                        var t = a.data.key.children,
                            i = e[t];
                        view.removeChildNodes(a, e);
                        return i ? i: null
                    },
                    removeNode: function(e, t) {
                        if (e) {
                            t = !!t;
                            if (!t || 0 != tools.apply(a.callback.beforeRemove, [a.treeId, e], !0)) {
                                view.removeNode(a, e);
                                t && this.setting.treeObj.trigger(consts.event.REMOVE, [a.treeId, e])
                            }
                        }
                    },
                    selectNode: function(e, t) {
                        if (e && tools.uCanDo(a)) {
                            t = a.view.selectedMulti && t;
                            if (e.parentTId) view.expandCollapseParentNode(a, e.getParentNode(), !0, !1,
                                function() {
                                    try {
                                        $$(e, a).focus().blur()
                                    } catch(t) {}
                    ...
                    updateNode: function(e) {
                        if (e) {
                            var t = $$(e, a);
                            if (t.get(0) && tools.uCanDo(a)) {
                                view.setNodeName(a, e);
                                view.setNodeTarget(a, e);
                                view.setNodeUrl(a, e);
                                view.setNodeLineIcos(a, e);
                                view.setNodeFontCss(a, e)
                            }
                        }
                    }
                };
                n.treeTools = o;
                data.setZTreeTools(a, o);
                n[s] && n[s].length > 0 ? view.createNodes(a, 0, n[s]) : a.async.enable && a.async.url && "" !== a.async.url && view.asyncNode(a);
                return o
            }
        };
        var zt = $.fn.zTree,
    ...
    function(e) {
        var t = {
            ...
            s = function(e) {
                ...
                t.bind(i.CHECK,
                    function(t, i, a, n) {
                        t.srcEvent = i;
                        N.apply(e.callback.onCheck, [t, a, n])
                    })
            },
            o = function(e) {
                var t = e.treeObj,
            ...
            l = function(e, t, i, a) {
                if (i) {
                    ...
                    "string" == typeof i[n] && (i[n] = N.eqs(i[n], "true"));
                    i[n] = !!i[n];
                    i.checkedOld = i[n];
                    "string" == typeof i.nocheck && (i.nocheck = N.eqs(i.nocheck, "true"));
                    i.nocheck = !!i.nocheck || e.check.nocheckInherit && a && !!a.nocheck;
                    "string" == typeof i.chkDisabled && (i.chkDisabled = N.eqs(i.chkDisabled, "true"));
                    i.chkDisabled = !!i.chkDisabled || e.check.chkDisabledInherit && a && !!a.chkDisabled;
                    ...
                    if (e.check.chkStyle == C.radio.STYLE && e.check.radioType == C.radio.TYPE_ALL && i[n]) {
                        var s = b.getRoot(e);
            ...
            c = function(e, t) {
                t.checkNode = function(e, t, i, a) {
                    var n = this.setting.data.key.checked;
                    if (e.chkDisabled !== !0) {
                        t !== !0 && t !== !1 && (t = !e[n]);
                        a = !!a;
                        if ((e[n] !== t || i) && (!a || 0 != N.apply(this.setting.callback.beforeCheck, [this.setting.treeId, e], !0)) && N.uCanDo(this.setting) && this.setting.check.enable && e.nocheck !== !0) {
                            e[n] = t;
                            var s = k(e, C.id.CHECK, this.setting); (i || this.setting.check.chkStyle === C.radio.STYLE) && y.checkNodeRelation(this.setting, e);
                            y.setChkClass(this.setting, s, e);
                            y.repairParentChkClassWithSelf(this.setting, e);
                            a && this.setting.treeObj.trigger(C.event.CHECK, [null, this.setting.treeId, e])
                        }
                    }
                };
                ...
                t.setChkDisabled = function(e, t, i, a) {
                    t = !!t;
                    i = !!i;
                    a = !!a;
                    y.repairSonChkDisabled(this.setting, e, t, a);
                    y.repairParentChkDisabled(this.setting, e.getParentNode(), t, i)
                };
                var i = t.updateNode;
                t.updateNode = function(e, a) {
                    i && i.apply(t, arguments);
                    if (e && this.setting.check.enable) {
                        var n = k(e, this.setting);
                        if (n.get(0) && N.uCanDo(this.setting)) {
                            var s = k(e, C.id.CHECK, this.setting); (1 == a || this.setting.check.chkStyle === C.radio.STYLE) && y.checkNodeRelation(this.setting, e);
                            y.setChkClass(this.setting, s, e);
                            y.repairParentChkClassWithSelf(this.setting, e)
                        }
                    }
            ...
            u = {
                getRadioCheckedList: function(e) {
                    for (var t = b.getRoot(e).radioCheckedList, i = 0, a = t.length; a > i; i++) if (!b.getNodeCache(e, t[i].tId)) {
                        t.splice(i, 1);
                        i--;
                        a--
                    }
                ...
                getTreeCheckedNodes: function(e, t, i, a) {
                    if (!t) return [];
                    var n = e.data.key.children,
                        s = e.data.key.checked,
                        o = i && e.check.chkStyle == C.radio.STYLE && e.check.radioType == C.radio.TYPE_ALL;
                    a = a ? a: [];
                    for (var r = 0,
                             l = t.length; l > r; r++) {
                        ...
                        b.getTreeCheckedNodes(e, t[r][n], i, a);
                ...
                getTreeChangeCheckedNodes: function(e, t, i) {
                    ...
                    for (var s = 0,
                             o = t.length; o > s; s++) {
                        t[s].nocheck !== !0 && t[s].chkDisabled !== !0 && t[s][n] != t[s].checkedOld && i.push(t[s]);
                        b.getTreeChangeCheckedNodes(e, t[s][a], i)
                    }
                    return i
                },
                    ...
                    if (t) {
                        ...
                        if (t[i]) for (var s = 0,
                            ...
                            if (e.check.chkStyle == C.radio.STYLE) {
                                l = r.nocheck === !0 || r.chkDisabled === !0 ? r.check_Child_State: r.halfCheck === !0 ? 2 : r[a] ? 2 : r.check_Child_State > 0 ? 2 : 0;
                                if (2 == l) {
                                    n = 2;
                                    break
                                }
                                ...
                                l = r.nocheck === !0 || r.chkDisabled === !0 ? r.check_Child_State: r.halfCheck === !0 ? 1 : r[a] ? -1 === r.check_Child_State || 2 === r.check_Child_State ? 2 : 1 : r.check_Child_State > 0 ? 1 : 0;
                                if (1 === l) {
                                    n = 1;
                                    break
                                }
            ...
            p = {
                checkNodeRelation: function(e, t) {
                    var i, a, n, s = e.data.key.children,
                    ...
                    if (e.check.chkStyle == r.STYLE) {
                        ...
                        } else if (e.check.radioType == r.TYPE_ALL) for (a = 0, n = l.length; n > a; a++) if (t == l[a]) {
                            l.splice(a, 1);
                            break
                        }
                    } else {
                        ...
                        t[o] && e.check.chkboxType.Y.indexOf("p") > -1 && y.setParentNodeCheckBox(e, t, !0); ! t[o] && e.check.chkboxType.N.indexOf("p") > -1 && y.setParentNodeCheckBox(e, t, !1)
                    }
                },
                makeChkClass: function(e, t) {
                    var i = e.data.key.checked,
                        ...
                        n = C.radio,
                        s = "";
                    s = t.chkDisabled === !0 ? a.DISABLED: t.halfCheck ? a.PART: e.check.chkStyle == n.STYLE ? t.check_Child_State < 1 ? a.FULL: a.PART: t[i] ? 2 === t.check_Child_State || -1 === t.check_Child_State ? a.FULL: a.PART: t.check_Child_State < 1 ? a.FULL: a.PART;
                    var o = e.check.chkStyle + "_" + (t[i] ? a.TRUE: a.FALSE) + "_" + s;
                    o = t.check_Focus && t.chkDisabled !== !0 ? o + "_" + a.FOCUS: o;
                    return C.className.BUTTON + " " + a.DEFAULT + " " + o
                },
                repairAllChk: function(e, t) {
                    if (e.check.enable && e.check.chkStyle === C.checkbox.STYLE) for (var i = e.data.key.checked,
                                                                                          a = e.data.key.children,
                                                                                          n = b.getRoot(e), s = 0, o = n[a].length; o > s; s++) {
                        var r = n[a][s];
                ...
                repairSonChkDisabled: function(e, t, i, a) {
                    if (t) {
                        var n = e.data.key.children;
                        t.chkDisabled != i && (t.chkDisabled = i);
                        y.repairChkClass(e, t);
                        if (t[n] && a) for (var s = 0,
                                                o = t[n].length; o > s; s++) {
                            var r = t[n][s];
                            y.repairSonChkDisabled(e, r, i, a)
                        }
                    }
                },
                repairParentChkDisabled: function(e, t, i, a) {
                    if (t) {
                        t.chkDisabled != i && a && (t.chkDisabled = i);
                        y.repairChkClass(e, t);
                        y.repairParentChkDisabled(e, t.getParentNode(), i, a)
                    }
                },
                ...
                setParentNodeCheckBox: function(e, t, i, a) {
                    var n = e.data.key.children,
                        s = e.data.key.checked,
                        o = k(t, C.id.CHECK, e);
                    a || (a = t);
                    ...
                    if (t.nocheck !== !0 && t.chkDisabled !== !0) {
                        t[s] = i;
                        y.setChkClass(e, o, t);
                        e.check.autoCheckTrigger && t != a && e.treeObj.trigger(C.event.CHECK, [null, e.treeId, t])
                    }
                    if (t.parentTId) {
                        var r = !0;
                        if (!i) for (var l = t.getParentNode()[n], d = 0, c = l.length; c > d; d++) if (l[d].nocheck !== !0 && l[d].chkDisabled !== !0 && l[d][s] || (l[d].nocheck === !0 || l[d].chkDisabled === !0) && l[d].check_Child_State > 0) {
                            r = !1;
                            break
                        }
                        r && y.setParentNodeCheckBox(e, t.getParentNode(), i, a)
                    }
                },
                setSonNodeCheckBox: function(e, t, i, a) {
                    if (t) {
                        var n = e.data.key.children,
                            s = e.data.key.checked,
                            o = k(t, C.id.CHECK, e);
                        ...
                        var r = !1;
                        if (t[n]) for (var l = 0,
                                           d = t[n].length; d > l && t.chkDisabled !== !0; l++) {
                            var c = t[n][l];
                            y.setSonNodeCheckBox(e, c, i, a);
                            c.chkDisabled === !0 && (r = !0)
                        }
                        if (t != b.getRoot(e) && t.chkDisabled !== !0) {
                            ...
                            if (t.nocheck !== !0 && t.chkDisabled !== !0) {
                                t[s] = i;
                                r || (t.check_Child_State = t[n] && t[n].length > 0 ? i ? 2 : 0 : -1)
                            } else t.check_Child_State = -1;
                            y.setChkClass(e, o, t);
                            e.check.autoCheckTrigger && t != a && t.nocheck !== !0 && t.chkDisabled !== !0 && e.treeObj.trigger(C.event.CHECK, [null, e.treeId, t])
                        }
                    }
                }
            },
        ...
        b.addZTreeTools(c);
        var w = y.createNodes;
        y.createNodes = function(e, t, i, a) {
            w && w.apply(y, arguments);
            i && y.repairParentChkClassWithSelf(e, a)
        };
        var T = y.removeNode;
        ...
        var D = y.appendNodes;
        y.appendNodes = function(e, t, i, a) {
            var n = "";
            D && (n = D.apply(y, arguments));
            a && b.makeChkFlag(e, a);
            return n
        }
    } (jQuery); !
    function(e) {
        var t = {
            ...
            s = function(e) {
                ...
                t.bind(i.RENAME,
                    function(t, i, a, n) {
                        m.apply(e.callback.onRename, [t, i, a, n])
                    });
                t.bind(i.DRAG,
                    function(t, i, a, n) {
                        m.apply(e.callback.onDrag, [i, a, n])
                    });
                t.bind(i.DRAGMOVE,
                    function(t, i, a, n) {
                        m.apply(e.callback.onDragMove, [i, a, n])
                    });
                t.bind(i.DROP,
                    function(t, i, a, n, s, o, r) {
                        m.apply(e.callback.onDrop, [i, a, n, s, o, r])
                    })
            },
            o = function(e) {
                var t = e.treeObj,
            ...
            d = function(e, t) {
                ...
                t.copyNode = function(e, t, i, a) {
                    function n() {
                        C.addNodes(s.setting, e, [o], a)
                    }
                    if (!t) return null;
                    ...
                    if (i == N.move.TYPE_INNER) m.canAsync(this.setting, e) ? C.asyncNode(this.setting, e, a, n) : n();
                    else {
                        C.addNodes(this.setting, e.parentNode, [o], a);
                        C.moveNode(this.setting, e, o, i, !1, a)
                    }
                    return o
                };
                ...
                t.moveNode = function(e, t, i, a) {
                    function n() {
                        C.moveNode(s.setting, e, t, i, !1, a)
                    }
                    if (!t) return t;
                    if (e && !e.isParent && this.setting.data.keep.leaf && i === N.move.TYPE_INNER) return null;
                    ...
                    e || (e = null);
                    var s = this;
                    m.canAsync(this.setting, e) && i === N.move.TYPE_INNER ? C.asyncNode(this.setting, e, a, n) : n();
                    return t
                };
            ...
            c = {
                setSonNodeLevel: function(e, t, i) {
                    if (i) {
                        ...
                        if (i[a]) for (var n = 0,
                                           s = i[a].length; s > n; n++) i[a][n] && y.setSonNodeLevel(e, i, i[a][n])
                    }
                }
            },
            u = {},
            h = {
                onHoverOverNode: function(e, t) {
                    var i = y.getSetting(e.data.treeId),
                        a = y.getRoot(i);
                    a.curHoverNode != t && h.onHoverOutNode(e);
                    a.curHoverNode = t;
                    C.addHoverDom(i, t)
                },
                onHoverOutNode: function(e) {
                    var t = y.getSetting(e.data.treeId),
                        i = y.getRoot(t);
                ...
                onMousedownNode: function(i, a) {
                    function n(i) {
                        ...
                        if (0 == c.dragFlag) {
                            ...
                            for (a = 0, n = g.length; n > a; a++) {
                                0 == a && (c.dragNodeShowBefore = []);
                                o = g[a];
                            ...
                            if (g.length > 1) {
                                ...
                                l = [];
                                for (a = 0, n = M.length; n > a; a++) {
                                    if (void 0 !== c.dragNodeShowBefore[M[a].tId]) {
                                        f && x > -1 && x + 1 !== a && (f = !1);
                                        l.push(M[a]);
                                        x = a
                                    }
                            ...
                            for (a = 0, n = g.length; n > a; a++) {
                                o = g[a];
                                o.editNameFlag = !1;
                                C.selectNode(d, o, a > 0);
                                C.removeTreeDom(d, o);
                                if (! (a > d.edit.drag.maxShowNodeNum - 1)) {
                        ...
                        if (1 == c.dragFlag) {
                            ...
                            var H = D.scrollTop(),
                                $ = D.scrollLeft(),
                                Y = I.treeObj.offset(),
                                U = I.treeObj.get(0).scrollHeight,
                                W = I.treeObj.get(0).scrollWidth,
                                q = i.clientY + H - Y.top,
                                K = I.treeObj.height() + Y.top - i.clientY - H,
                                V = i.clientX + $ - Y.left,
                                G = I.treeObj.width() + Y.left - i.clientX - $,
                                X = q < d.edit.drag.borderMax && q > d.edit.drag.borderMin,
                                Q = K < d.edit.drag.borderMax && K > d.edit.drag.borderMin,
                                Z = V < d.edit.drag.borderMax && V > d.edit.drag.borderMin,
                                J = G < d.edit.drag.borderMax && G > d.edit.drag.borderMin,
                                et = q > d.edit.drag.borderMin && K > d.edit.drag.borderMin && V > d.edit.drag.borderMin && G > d.edit.drag.borderMin,
                                tt = X && I.treeObj.scrollTop() <= 0,
                                it = Q && I.treeObj.scrollTop() + I.treeObj.height() + 10 >= U,
                                at = Z && I.treeObj.scrollLeft() <= 0,
                                nt = J && I.treeObj.scrollLeft() + I.treeObj.width() + 10 >= W;
                            ...
                            o = g[0];
                            if (et && m.isChildOrSelf(i.target, I.treeId)) { ! k && (i.target.id == I.treeId || tt || it || at || nt) && (E || !E && o.parentTId) && (k = I.treeObj);
                                X ? I.treeObj.scrollTop(I.treeObj.scrollTop() - 10) : Q && I.treeObj.scrollTop(I.treeObj.scrollTop() + 10);
                                Z ? I.treeObj.scrollLeft(I.treeObj.scrollLeft() - 10) : J && I.treeObj.scrollLeft(I.treeObj.scrollLeft() + 10);
                            ...
                            p.css({
                                top: i.clientY + H + 3 + "px",
                                left: i.clientX + $ + 3 + "px"
                            });
                            var rt = 0,
                                lt = 0;
                            if (k && k.attr("id") != I.treeId) {
                                var dt = null == L ? null: y.getNodeCache(I, L),
                                    ct = (i.ctrlKey || i.metaKey) && d.edit.drag.isMove && d.edit.drag.isCopy || !d.edit.drag.isMove && d.edit.drag.isCopy,
                                    ut = !(!w || L !== w.tId),
                                    ht = !(!T || L !== T.tId),
                                    ft = o.parentTId && o.parentTId == L,
                                    gt = (ct || !ht) && m.apply(I.edit.drag.prev, [I.treeId, g, dt], !!I.edit.drag.prev),
                                    pt = (ct || !ut) && m.apply(I.edit.drag.next, [I.treeId, g, dt], !!I.edit.drag.next),
                                    vt = !(!ct && ft || I.data.keep.leaf && !dt.isParent || !m.apply(I.edit.drag.inner, [I.treeId, g, dt], !!I.edit.drag.inner));
                                if (gt || pt || vt) {
                                    var mt = e("#" + L + N.id.A, k),
                                        Nt = dt.isLastNode ? null: e("#" + dt.getNextNode().tId + N.id.A, k.next()),
                                        Ct = mt.offset().top,
                                        yt = mt.offset().left,
                                        bt = gt ? vt ? .25 : pt ? .5 : 1 : -1,
                                        kt = pt ? vt ? .75 : gt ? .5 : 0 : -1,
                                        wt = (i.clientY + H - Ct) / mt.height();
                                    ...
                                    mt.addClass(N.node.TMPTARGET_NODE + "_" + R); (F != L || S != R) && (O = (new Date).getTime());
                    ...
                    function s(i) {
                        function a() {
                            if (E) {
                                if (!f) for (var e = 0,
                                                 t = g.length; t > e; e++) C.removeNode(d, g[e]);
                                if (R == N.move.TYPE_INNER) C.addNodes(I, w, T);
                                else {
                                    C.addNodes(I, w.getParentNode(), T);
                                    if (R == N.move.TYPE_PREV) for (e = 0, t = T.length; t > e; e++) C.moveNode(I, w, T[e], R, !1);
                                    else for (e = -1, t = T.length - 1; t > e; t--) C.moveNode(I, w, T[t], R, !1)
                                }
                            } else if (f && R == N.move.TYPE_INNER) C.addNodes(I, w, T);
                            else {
                                f && C.addNodes(I, w.getParentNode(), T);
                                if (R != N.move.TYPE_NEXT) for (e = 0, t = T.length; t > e; e++) C.moveNode(I, w, T[e], R, !1);
                                else for (e = -1, t = T.length - 1; t > e; t--) C.moveNode(I, w, T[t], R, !1)
                            }
                            C.selectNodes(I, T);
                            b(T[0], d).focus().blur();
                        ...
                        if (0 != c.dragFlag) {
                            ...
                            p && p.remove();
                            v && v.remove();
                            var f = (i.ctrlKey || i.metaKey) && d.edit.drag.isMove && d.edit.drag.isCopy || !d.edit.drag.isMove && d.edit.drag.isCopy; ! f && k && L && g[0].parentTId && L == g[0].parentTId && R == N.move.TYPE_INNER && (k = null);
                            if (k) {
                                ...
                                var T = f ? m.clone(g) : g;
                                R == N.move.TYPE_INNER && m.canAsync(I, w) ? C.asyncNode(I, w, !1, a) : a()
                            } else {
                                C.selectNodes(x, g);
                    ...
                    var r, l, d = y.getSetting(i.data.treeId),
                        c = y.getRoot(d),
                        u = y.getRoots();
                    if (2 == i.button || !d.edit.enable || !d.edit.drag.isCopy && !d.edit.drag.isMove) return ! 0;
                    var h = i.target,
                        f = y.getRoot(d).curSelectedList,
                        g = [];
                    if (y.isSelectedNode(d, a)) for (r = 0, l = f.length; l > r; r++) {
                    ...
                    var p, v, k, w, T, D = e(d.treeObj.get(0).ownerDocument),
                        _ = e(d.treeObj.get(0).ownerDocument.body),
                        E = !1,
                        I = d,
                        x = d,
                        F = null,
            ...
            f = {
                ...
                showIfameMask: function(e, t) {
                    ...
                    if (t) for (var a = b("iframe", e), n = 0, s = a.length; s > n; n++) {
                        var o = a.get(n),
                            r = m.getAbs(o),
                            l = b("<div id='zTreeMask_" + n + "' class='zTreeMask' style='top:" + r[1] + "px; left:" + r[0] + "px; width:" + o.offsetWidth + "px; height:" + o.offsetHeight + "px;'></div>", e);
                        l.appendTo(b("body", e));
            ...
            g = {
                addEditBtn: function(e, t) {
                    if (! (t.editNameFlag || b(t, N.id.EDIT, e).length > 0) && m.apply(e.edit.showRenameBtn, [e.treeId, t], e.edit.showRenameBtn)) {
                        var i = b(t, N.id.A, e),
                            a = "<span class='" + N.className.BUTTON + " edit' id='" + t.tId + N.id.EDIT + "' title='" + m.apply(e.edit.renameTitle, [e.treeId, t], e.edit.renameTitle) + "' treeNode" + N.id.EDIT + " style='display:none;'></span>";
                        i.append(a);
                        b(t, N.id.EDIT, e).bind("click",
                            function() {
                ...
                addRemoveBtn: function(e, t) {
                    if (! (t.editNameFlag || b(t, N.id.REMOVE, e).length > 0) && m.apply(e.edit.showRemoveBtn, [e.treeId, t], e.edit.showRemoveBtn)) {
                        var i = b(t, N.id.A, e),
                            a = "<span class='" + N.className.BUTTON + " remove' id='" + t.tId + N.id.REMOVE + "' title='" + m.apply(e.edit.removeTitle, [e.treeId, t], e.edit.removeTitle) + "' treeNode" + N.id.REMOVE + " style='display:none;'></span>";
                        i.append(a);
                        b(t, N.id.REMOVE, e).bind("click",
                            function() {
                ...
                editNode: function(e, t) {
                    ...
                    if (y.isSelectedNode(e, t) && i.curEditNode == t && t.editNameFlag) setTimeout(function() {
                        ...
                        var n = b(t, N.id.INPUT, e);
                        n.attr("value", t[a]);
                        e.edit.editNameSelectAll ? m.inputSelect(n) : m.inputFocus(n);
                        n.bind("blur",
                            function() {
                ...
                moveNode: function(e, t, i, a, n, s) {
                    var o = y.getRoot(e),
                        r = e.data.key.children;
                    if (t != i && (!e.data.keep.leaf || !t || t.isParent || a != N.move.TYPE_INNER)) {
                        var l = i.parentTId ? i.getParentNode() : o,
                            d = null === t || t == o;
                        d && null === t && (t = o);
                        d && (a = N.move.TYPE_INNER);
                        var c = t.parentTId ? t.getParentNode() : o;
                        a != N.move.TYPE_PREV && a != N.move.TYPE_NEXT && (a = N.move.TYPE_INNER);
                        if (a == N.move.TYPE_INNER) if (d) i.parentTId = null;
                        else {
                            if (!t.isParent) {
                                t.isParent = !0;
                                t.open = !!t.open;
                        ...
                        if (d) {
                            ...
                            s || a != N.move.TYPE_INNER ? s || C.expandCollapseNode(e, t.getParentNode(), !0, !1) : C.expandCollapseNode(e, t, !0, !1);
                            u = b(t, e);
                            h = b(t, N.id.UL, e);
                            if (u.get(0) && !h.get(0)) {
                                var f = [];
                        ...
                        h.get(0) && a == N.move.TYPE_INNER ? h.append(g) : u.get(0) && a == N.move.TYPE_PREV ? u.before(g) : u.get(0) && a == N.move.TYPE_NEXT && u.after(g);
                        var p, v, m = -1,
                            k = 0,
                            w = null,
                            T = null,
                        ...
                        m >= 0 && l[r].splice(m, 1);
                        if (a != N.move.TYPE_INNER) for (p = 0, v = c[r].length; v > p; p++) c[r][p].tId == t.tId && (k = p);
                        if (a == N.move.TYPE_INNER) {
                            t[r] || (t[r] = new Array);
                            if (t[r].length > 0) {
                                T = t[r][t[r].length - 1];
                                T.isLastNode = !1
                        ...
                        } else if (t.isFirstNode && a == N.move.TYPE_PREV) {
                            c[r].splice(k, 0, i);
                            T = t;
                            T.isFirstNode = !1;
                            ...
                            i.isFirstNode = !0;
                            i.isLastNode = !1
                        } else if (t.isLastNode && a == N.move.TYPE_NEXT) {
                            c[r].splice(k + 1, 0, i);
                            T = t;
                            T.isLastNode = !1;
                            i.parentTId = t.parentTId;
                            ...
                            a == N.move.TYPE_PREV ? c[r].splice(k, 0, i) : c[r].splice(k + 1, 0, i);
                            i.parentTId = t.parentTId;
                            i.isFirstNode = !1;
                            i.isLastNode = !1
                        }
                        ...
                        if (!e.data.keep.parent && l[r].length < 1) {
                            ...
                            var _ = b(l, N.id.UL, e),
                                E = b(l, N.id.SWITCH, e),
                                I = b(l, N.id.ICON, e);
                            C.replaceSwitchClass(l, E, N.folder.DOCU);
                        ...
                        s || C.expandCollapseParentNode(e, i.getParentNode(), !0, n)
                    }
                },
                ...
                repairNodeLevelClass: function(e, t, i) {
                    if (i !== t.level) {
                        var a = b(t, e),
                            n = b(t, N.id.A, e),
                            s = b(t, N.id.UL, e),
                            o = N.className.LEVEL + i,
                            r = N.className.LEVEL + t.level;
                        a.removeClass(o);
                        a.addClass(r);
                        n.removeClass(o);
                        n.addClass(r);
                ...
                selectNodes: function(e, t) {
                    for (var i = 0,
                             a = t.length; a > i; i++) C.selectNode(e, t[i], i > 0)
                }
            },
            p = {
                tools: f,
        ...
        C.cancelPreSelectedNode = function(e, t) {
            for (var i = y.getRoot(e).curSelectedList, a = 0, n = i.length; n > a; a++) if (!t || t === i[a]) {
                C.removeTreeDom(e, i[a]);
                if (t) break
            }
            k && k.apply(C, arguments)
        };
        var w = C.createNodes;
        C.createNodes = function(e, t, i, a) {
            w && w.apply(C, arguments);
            i && C.repairParentChkClassWithSelf && C.repairParentChkClassWithSelf(e, a)
        };
        var T = C.makeNodeUrl;
        ...
        m.uCanDo = function(e, t) {
            ...
            return ! i.curEditNode && (E ? E.apply(C, arguments) : !0)
        }
    } (jQuery); (typeof define === "function") && define(function(require) {
