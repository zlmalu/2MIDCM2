...
//					})
			...
			if (e.id > 0) {
				...
				this.$_toolBottom.html('<a id="savaAndAdd" class="ui-btn ui-btn-sp mrb">保存并新增</a>');
...
/*			var i = t.$_customer.find("input");
			...
			if (r.length > 0) {
				...
				var n = {
					...
					buId: 0,
					/*contactName: a.name,*/
					createName:$("#userName").text(),
					billNo: $.trim(e.$_number.text()),
					Stock_ID: $.trim(e.$_storehouse.val()),
					entries: r
				};
				return n
			}
