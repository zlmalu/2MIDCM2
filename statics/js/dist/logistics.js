...
//					})
            ...
            this.$_orderName.val(t.Name);
            this.$_paymentType.val(t.paymentType);
            this.$_Desc.val(t.Desc);
            if (requiredMoney) {
                $("#accountWrap").show();
        ...
        addEvent: function() {
            ...
            $(".wrapper").on("click", "#save", function(e) {
                ...
                if (i) {
                    ...
                    Public.ajaxPost(logistics_add+"?act=add", {
            ...
            $(".wrapper").on("click", "#edit", function(t) {
                t.preventDefault();
                    ...
                    e && Public.ajaxPost(logistics_edit, {
