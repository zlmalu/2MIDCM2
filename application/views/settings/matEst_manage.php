...
<head>
    ...
    <script type="text/javascript">
        ...
        var matest_save  = "<?=site_url('matest/save')?>";
    ...
    <div id="manage-wrap" class="manage-wrap">
        <form id="manage-form" action="">
            <ul class="mod-form-rows base-form cf" id="base-form">
                <li class="row-item">
                    <div class="label-wrap"><label for="Date">日期</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="Date" id="Date"></div>
                </li>
                <li class="row-item">
                ...
                <li class="row-item">
                    <div class="label-wrap"><label for="AmOfDem">总需求量</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="AmOfDem" id="AmOfDem"></div>
                </li>
                <li class="row-item">
                    <div class="label-wrap"><label for="AmOfSto">库存量</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="AmOfSto" id="AmOfSto"></div>
                </li>
                <li class="row-item">
                    <div class="label-wrap"><label for="AmOfPro">需生产量</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="AmOfPro" id="AmOfPro"></div>
                </li>
                <li class="row-item">
                    <div class="label-wrap"><label for="AmOfPur">需采购量</label></div>
                    <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="AmOfPur" id="AmOfPur"></div>
                </li>
            </ul>
        </form>
    </div>
...
<script src="<?=skin_url()?>/js/dist/matEstManage.js"></script>
</body>
</html>
