...
<head>
    ...
    <script type="text/javascript">
        ...
        var settings_matTem_Design_manage = "<?=site_url('settings/matTem_Design_manage')?>";
        ...
        var matTemDesign_lists  = "<?=site_url('matTemDesign/lists')?>";
        var settings_inventory =  "<?=site_url('settings/inventory')?>";
        var settings_spec_info1 = "<?=site_url('settings/spec_info1')?>";
        var settings_spec_info2 = "<?=site_url('settings/spec_info2')?>";
        var matTemDesign_del    = "<?=site_url('matTemDesign/del')?>";
        var settings_skins =  "<?=site_url('settings/skins')?>";
        var customer_export  = "<?=site_url('customer/export')?>";
        var MatTemplate_del    = "<?=site_url('MatTemplate/del')?>";
    </script>
    <style>
...
<div class="wrapper">
    <div class="mod-search cf">
        <div class="fl">
            <ul class="ul-inline">
                <li>
                    <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="输入bom设计 / 工作流程模板设计名称 / 上位物料 / 下位物料 查询">
                </li>
...
<script src="<?=skin_url()?>/js/dist/matTemDesignList.js"></script>
</body>
</html>
