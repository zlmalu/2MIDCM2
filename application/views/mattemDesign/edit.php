...
<head>
    ...
    <script src="<?=skin_url()?>/js/common/common4.js?ver=20140815"></script>
    ...
    <script type="text/javascript">
        ...
        var matTemDesign_info   = "<?=site_url('matTemDesign/info')?>";
        ...
        var mattemDesign_edit    = "<?=site_url('matTemDesign/edit')?>";
...
<script src="<?=skin_url()?>/js/dist/matTemDesignEdit.js?2"></script>
</body>
</html>
