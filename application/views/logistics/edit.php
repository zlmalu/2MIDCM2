...
var settings_select_logistics =  "<?=site_url('settings/select_logistics')?>";
    ...
    <div class="con-footer cf">
      <div class="mb10">
        ...
        <div class="mb10">
            ...
            <div class="ctn-wrap">
                <input type="text" id="Desc" class="ui-input"  style="width:100%; margin:0 -6px; ">
            </div>
        </div>
<!--      	<div class="label-wrap">
        	<label>备注:</label>
...
<script src="<?=skin_url()?>/js/dist/logistics.js?cc23"></script>
</body>
</html>
