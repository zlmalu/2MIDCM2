            ...
            <form action="#" id="registerForm" class="register-form">
              <ul class="mod-form-rows">
                  ...
                  <li class="row-item">
                      ...
                      <div class="ctn-wrap">
                          <input type="text" class="ui-input" id="uid" name="uid" hidden value="<?php echo $PK_User_ID; ?>"/>
                          <input type="text" class="ui-input" id="userName" name="userName"  value="<?php echo $Username; ?>"/>
                  ...
                  <li class="row-item">
                    ...
                    <input type="text" name="filter-user" id="filter-Part_ID" class="input-txt" value="<?php echo $Part_ID; ?>" autocomplete="off"/>
                  ...
                  <li class="row-item">
                      ...
                      <div class="ctn-wrap">
                          <input type="text" class="ui-input" id="Desc" name="Desc"  value="<?php echo $Desc; ?>"/>
                      </div>
                  </li>
                ...
                <li class="row-item">
                  ...
                  <div class="ctn-wrap">
                      <input type="oldpwd" class="ui-input" id="oldpwd" name="oldpwd" hidden value="<?php echo $Userpwd; ?>" onpaste="return false;" />
                      <input type="password" class="ui-input" id="password" name="password" style="ime-mode:disabled;" value="<?php echo $Userpwd; ?>" onpaste="return false;" />
                ...
                <li class="row-item">
                  ...
                  <div class="ctn-wrap">
                    <input type="password" class="ui-input" id="pswConfirm" name="pswConfirm" style="ime-mode:disabled;" value="<?php echo $Userpwd; ?>" onpaste="return false;"/>
                  </div>
                </li>
