...
<head>
    ...
    <script type="text/javascript">
        ...
        var matEst_del    = "<?=site_url('matest/del')?>";
        var matEst_lists  = "<?=site_url('matest/lists')?>";
        var matEst_add    = "<?=site_url('matest/add')?>";
...
<div class="wrapper">
    <div class="mod-search cf">
        <div class="fl">
            <ul class="ul-inline">
                <li>
                    <input type="text" id="matchCon" class="ui-input ui-input-ph" value="请输入物料名称">
                </li>
...
<script src="<?=skin_url()?>/js/dist/matEstList.js"></script>
</body>
</html>
