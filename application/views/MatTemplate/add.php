        ...
        <form id="manage-form" action="">
            <ul class="mod-form-rows base-form cf" id="base-form">
                <li class="row-item">
                    ...
                    <div class="ctn-wrap">
                        <select name="IsKey" id="selfClass" onChange="level1Change()" style="height: 30px;width:100px">
...
<!--                </li>-->
                ...
                <li class="row-item">
                    ...
                    <div class="ctn-wrap"><input type="text" onkeyup="value=value.match(/20|1\d|\d/,'')" class="ui-input" name="AttrNum"  onfocus="inputFocus()" onblur="numberChange()" id="AttrNum" placeholder="请输入1-20的数字"></div>
                </li>
            </ul>
            <ul class="mod-form-rows base-form cf" id="attr-form">
                <li class="row-item">
                    <div class="label-wrap"> <label  class="tit" for="Attr1">属性1：</label></div>
                    <div class="ctn-wrap"><span class="ui-combo-wrap" id="Attr1">
                ...
                <li class="row-item">
                    ...
                    <div class="ctn-wrap"><span class="ui-combo-wrap" id="Attr2">
                    <input type="text" name="filter-user" id="filter-FK_UnitClass_ID" class="Attr2" autocomplete="off" />
                    <span class="trigger"></span>
                    </span></div>
                </li>
                <li class="row-item">
                    <div class="label-wrap"> <label  class="tit" for="Attr3">属性3：</label></div>
                    <div class="ctn-wrap"><span class="ui-combo-wrap" id="Attr3">
                ...
                <li class="row-item">
                    ...
                    <div class="ctn-wrap"><span class="ui-combo-wrap" id="Attr4">
                ...
                <li class="row-item">
                    ...
                    <div class="ctn-wrap"><span class="ui-combo-wrap" id="Attr5">
...
<script src="<?=skin_url()?>/js/dist/MatTemplateAdd.js?339787"></script>
