...
<head>
    ...
    <script type="text/javascript">
        ...
        var addBomTempl_level1Change = "<?=site_url('addBomTempl/level1Change')?>";
    ...
    <script>
        ...
        function inputFocus() {
            if($("#inputAttr").val()==="");
                ...
                attrNum=parseInt($("#inputAttr").val());
        }
        function level1Change(){
            let Cat_ID2 = $("#level1").val();
            $.ajax({
                type: "post",
                url: addBomTempl_level1Change,
                dataType: 'json',
                data: {
                    Cat_ID2:Cat_ID2
                },
        ...
        <form id="manage-form" action="">
            <ul class="mod-form-rows base-form cf" id="base-form">
                ...
                <li class="row-item">
                    ...
                    <div class="ctn-wrap"><input type="text" onkeyup="value=value.match(/20|1\d|\d/,'')" class="ui-input" name="BOMName"  onfocus="inputFocus()" onblur="numberChange()" id="inputAttr" placeholder="请输入1-20的数字"></div>
                </li>
            </ul>
