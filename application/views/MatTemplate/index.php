...
<head>
    ...
    <script type="text/javascript">
        ...
        var settings_bom_templ_manage = "<?=site_url('settings/bom_templ_manage')?>";
        ...
        var basedata_bom_templ_init  = "<?=site_url('basedata/bom_templ_init')?>";
...
<div class="wrapper">
    <div class="mod-search cf">
        <div class="fl">
            <ul class="ul-inline">
                <li>
                    <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="输入模板编号/ 大类 / 小类 / 名称查询">
                </li>
...
<script src="<?=skin_url()?>/js/dist/MatTemplateList.js?ver=9299"></script>
</body>
</html>
