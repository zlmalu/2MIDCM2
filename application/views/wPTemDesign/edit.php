...
<head>
    ...
    <script src="<?=skin_url()?>/js/common/common1.js?ver=20140815"></script>
    ...
    <script type="text/javascript">
        ...
        var wPTemDesign_info   = "<?=site_url('wPTemDesign/info')?>";
...
<script src="<?=skin_url()?>/js/dist/wPTemDesignEdit.js"></script>
</body>
</html>